...
if __name__ == '__main__':
    ...
    tgt_dir = '../../data/davis_domain_ncbi/'
    ...
    ref_map = {row['DeepDTA_gene_name']:row['ncbi_domain'] if not pd.isna(row['ncbi_domain']) else row['DeepDTA_seq'] for idx, row in ref.iterrows()}
    ans = {}
    for key in proteins:
        ans[key] = ref_map[key]
