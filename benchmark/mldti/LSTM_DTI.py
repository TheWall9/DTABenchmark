"""https://github.com/guaguabujianle/ML-DTI/blob/dev/network/LSTM_DTI.py"""
...
class DTImodel(nn.Module):
    def __init__(self, vocab_protein_size, vocab_ligand_size, embedding_size=128, filter_num=32):
        super().__init__()
        self.protein_encoder = TargetEncoder(vocab_protein_size, embedding_size, kernel_sizes=[4, 8, 12],
